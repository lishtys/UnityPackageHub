...
namespace Codes.Util.FluentExt.Unity
{
    ...
    public static class TransformExtensions
    {
        ...
        public static Transform GetNextSiblingTransform(this Transform transform)
        {
            ...
            return parent.GetChild(Mathf.Min(transform.GetSiblingIndex() + 1, parent.childCount - 1));
        }

        #endregion

        #region Children Oprators
 /// <summary>
        /// Gets list of all childs.
        /// </summary>
        /// <param name="transform">Target transform.</param>
        /// <returns>List of all childs.</returns>
        public static List<Transform> GetChildren(this Transform transform) => Enumerable.Range(0, transform.childCount).Select(index => transform.GetChild(index)).ToList();
        ...
        /// <param name="transform">Target transform.</param>
        public static void AddChildren(this Transform transform, params Transform[] childs) => AddChildren(transform, (IEnumerable<Transform>)childs);

        /// <summary>
        /// Adds childs to transform.
        /// </summary>
        /// <param name="transform">Target transform.</param>
        /// <param name="childs">Children to add.</param>
        public static void AddChildren(this Transform transform, IEnumerable<Transform> childs)
        {
        ...
        /// </summary>
        /// <param name="transform">Target transform.</param>
        public static void DestroyChildren(this Transform transform) => GetChildren(transform).ForEach(child => GameObject.Destroy(child.gameObject));
        ...
        public static void DestroyChildrenWhere(this Transform transform, Predicate<Transform> predicate)
        {
            var filtered = GetChildren(transform).Where(c => predicate(c));
